...
#############################################################################################
# WB model options
upgraded_model = 0 # use 1 to load our new model that is upgraded with new training examples.
...
gt = cv2.imread(os.path.join(gt_base, metadata["gt_filename"]), cv2.IMREAD_COLOR) # read gt image
...
in_base = os.path.join('..', 'examples_from_datasets', 'RenderedWB_Set2', 'input')
gt_base = os.path.join('..', 'examples_from_datasets', 'RenderedWB_Set2', 'groundtruth')
...
imgin = '19_F.JPG'
in_base = os.path.join('..', 'examples_from_datasets', 'Rendered_Cube+', 'input')
gt_base = os.path.join('..', 'examples_from_datasets', 'Rendered_Cube+', 'groundtruth')
